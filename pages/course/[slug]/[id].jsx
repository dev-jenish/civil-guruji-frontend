          ...
          </div>
          {
            selectedTopic?.subModule?.type == 1 && (
              <div className={styles.iframe}>
                ...
                {/* {console.log(selectedTopic?.subModule?.videoUrl?.split('/')[4])} */}
              ...
              <TabPanel>
                {
                  ...
                  meetingsData.map((meetingData, index) => {
                    return <SessionCard key={index} meetingData={meetingData} isLive={moment().isAfter(moment(meetingData?.start_time))} setSelectedTopic={setSelectedTopic} index={index} selectedSession={selectedSession} setSelectedSession={setSelectedSession} tabIndex={tabIndex}/>
                  })
                  :
